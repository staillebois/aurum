declare module "google-play-scraper" {
  ...
  export interface IFnList {
    <T extends IFnListOptions>(options: T): T extends { fullDetail: true }
      ? Promise<IAppItemFullDetail[]>
      : Promise<IAppItem[]>;
  }
  ...
  export interface IFnSearch {
    <T extends IFnSearchOptions>(options: T): T extends { fullDetail: true }
      ? Promise<IAppItemFullDetail[]>
      : Promise<IAppItem[]>;
  }
  ...
  export interface IFnSimilar {
    <T extends IFnSimilarOptions>(options: T): T extends { fullDetail: true }
      ? Promise<IAppItemFullDetail[]>
      : Promise<IAppItem[]>;
  }
